...
! function t(e, n, o) {
	...
	function(t, e, n) {"use strict";
		n.getWindow = function() {
			...
			getBrowserScrollPosition : function() {
				var t, e, o = n.getWindow(), i = n.getDocument(), r = i.documentElement, c = i.body;
				return
				void 0 !== o.pageYOffset ? ( t = o.pageXOffset, e = o.pageYOffset) : ( t = r.scrollLeft || c.scrollLeft || 0, e = r.scrollTop || c.scrollTop || 0), {
					x : t,
					y : e
				}
			},
			getScrollSpace : function() {
				var t = n.getDocument(), e = t.documentElement, o = t.body;
				return {
					x : o.scrollHeight - e.clientWidth,
					y : o.scrollHeight - e.clientHeight
				}
			},
			getElementIndex : function(t, e) {
				var n = document.getElementsByTagName(t);
				return Array.prototype.indexOf.call(n, e)
			},
			forceChange : function(t) {
				t.blur(), t.focus()
			},
			getElementData : function(t) {
				var e = t.tagName, o = n.utils.getElementIndex(e, t);
				return {
					tagName : e,
					index : o
				}
			},
			getSingleElement : function(t, e) {
				var n = document.getElementsByTagName(t);
				return n[e]
			},
			getBody : function() {
	...
	function(t, e, n) {"use strict";
		...
		n.init = function(t) {
			t.socket.on("file:reload", n.reload(t)), t.socket.on("browser:reload", function() {
				n.reloadBrowser(!0)
			})
		}, n.swapFile = function(t, e, n) {
			var i = t[e], r = (new Date).getTime(), c = "?rel=" + r, s = /^[^\?]+(?=\?)/.exec(i);
			s && ( i = s[0]), n && (n.timestamps || ( c = "")), t[e] = i + c;
			var a = document.body;
			return setTimeout(function() {
				o ? (o.style.display = "none", o.style.display = "block") : ( o = document.createElement("DIV"), a.appendChild(o))
			}, 200), {
				elem : t,
				timeStamp : r
			}
			...
			return function(e) {
				var o, i = t.opts, r = t.emitter;
				if ((e.url || !i.injectChanges) && n.reloadBrowser(!0), e.assetFileName && e.fileExtension) {
					var c = n.getElems(e.fileExtension), s = n.getMatches(c.elems, e.assetFileName, c.attr);
					s.length && i.notify && r.emit("notify", {
						message : "Injected: " + e.assetFileName
					});
					for (var a = 0, u = s.length; u > a; a += 1)
						o = n.swapFile(s[a], c.attr, i)
				}
				return o
			}
		}, n.getTagName = function(t) {
			return i.tagNames[t]
		}, n.getAttr = function(t) {
			return i.attrs[t]
		}, n.getMatches = function(t, e, n) {
			for (var o = [], i = 0, r = t.length; r > i; i += 1)
				-1 !== t[i][n].indexOf(e) && o.push(t[i]);
			return o
		}, n.getElems = function(t) {
			var e = n.getTagName(t), o = n.getAttr(e);
			return {
	...
	function(t, e, n) {"use strict";
		n.events = {}, n.emit = function(t, e) {
			...
			if (i && i.listeners) {
				o = i.listeners;
				for (var r = 0, c = o.length; c > r; r += 1)
					o[r](e)
			}
		}, n.on = function(t, e) {
			var o = n.events;
	...
	function(t, e, n) {
		n._ElementCache = function() {
			var t = {}, e = 1, n = "data" + (new Date).getTime();
			...
			if (!t || !t.stopPropagation) {
				...
				if (t.target || (t.target = t.srcElement || document), t.relatedTarget = t.fromElement === t.target ? t.toElement : t.fromElement, t.preventDefault = function() {
					...
					t.pageX = t.clientX + (r && r.scrollLeft || c && c.scrollLeft || 0) - (r && r.clientLeft || c && c.clientLeft || 0), t.pageY = t.clientY + (r && r.scrollTop || c && c.scrollTop || 0) - (r && r.clientTop || c && c.clientTop || 0)
				}
			...
			function e(e, n) {
				...
				var i = t.getData(e);
				0 === i.handlers[n].length && (
				delete i.handlers[n], document.removeEventListener ? e.removeEventListener(n, i.dispatcher, !1) : document.detachEvent && e.detachEvent("on" + n, i.dispatcher)), o(i.handlers) && (
				delete i.handlers,
				delete i.dispatcher), o(i) && t.removeData(e)
			}

			var o = 1;
			this.addEvent = function(e, i, r) {
				var c = t.getData(e);
				c.handlers || (c.handlers = {}), c.handlers[i] || (c.handlers[i] = []), r.guid || (r.guid = o++), c.handlers[i].push(r), c.dispatcher || (c.disabled = !1, c.dispatcher = function(t) {
					if (!c.disabled) {
						t = n._fixEvent(t);
						var o = c.handlers[t.type];
						if (o)
							for (var i = 0; i < o.length; i++)
								o[i].call(e, t)
					}
				}), 1 == c.handlers[i].length && (document.addEventListener ? e.addEventListener(i, c.dispatcher, !1) : document.attachEvent && e.attachEvent("on" + i, c.dispatcher))
			...
			var e;
			document.createEvent ? ( e = document.createEvent("MouseEvents"), e.initEvent("click", !0, !0), t.dispatchEvent(e)) : document.createEventObject && ( e = document.createEventObject(), e.cancelBubble = !0, t.fireEvent("onclick", e))
		};
		var o = new n._ElementCache, i = new n._EventManager(o);
		i.triggerClick = n.triggerClick, n.manager = i
	}, {}],
	6 : [
	function(t, e, n) {"use strict";
		var o = t("./socket"), i = (t("./client-shims"), t("./notify")), r = t("./code-sync"), c = t("./ghostmode"), s = t("./emitter"), a = t("./browser.utils"), u = function() {
			this.socket = o, this.emitter = s, this.utils = a.utils
		};
		u.prototype.canSync = function(t) {
			return t.url === window.location.pathname
		};
		var l;
		n.init = function(t) {
			window.___bs_client___ || (window.___bs_client___ = !0, l = new u, l.opts = t, t.notify && (i.init(l), i.flash("Connected to BrowserSync :)")), t.ghostMode && c.init(l), t.codeSync && r.init(l))
	...
	function(t, e, n) {"use strict";
		n.plugins = {
			...
			var i = !0, r = t.opts.ghostMode.forms;
			r === !0 && ( i = !1);
	...
	function(t, e, n) {"use strict";
		...
		n.canEmitEvents = !0, n.init = function(t, e) {
			...
			return function(e) {
				if (n.canEmitEvents) {
					var i = e.target || e.srcElement, r = t.utils.getElementData(i);
	...
	function(t, e, n) {"use strict";
		...
		n.canEmitEvents = !0, n.init = function(t, e) {
			...
			function n(n) {
				for (var o = 0, i = n.length; i > o; o += 1)
					t.addEvent(n[o], "change", e)
			}

			var o = document.getElementsByTagName("select"), i = document.getElementsByTagName("input");
			n(o), n(i)
		}, n.browserEvent = function(t) {
			return function(e) {
				if (n.canEmitEvents) {
	...
	function(t, e, n) {"use strict";
		var o, i = "scroll";
		n.canEmitEvents = !0, n.init = function(t, e) {
			o = t.utils, e.addEvent(window, i, n.browserEvent(t)), t.socket.on(i, n.socketEvent(t))
		}, n.socketEvent = function(t) {
			return function(e) {
				var i = o.getScrollSpace();
				return n.canEmitEvents = !1, t.canSync(e) ? t.opts && t.opts.scrollProportionally ? window.scrollTo(0, i.y * e.position.proportional) : window.scrollTo(0, e.position.raw) : !1
			}
		}, n.browserEvent = function(t) {
			return function() {
			...
			var e = o.getScrollSpace(), i = n.getScrollPercentage(e, t);
			return i.y
		}
	}, {}],
	15 : [
	function(t, e, n) {"use strict";
		var o, i, r, c = (t("./ghostmode.scroll"), ["background-color: black", "color: white", "padding: 10px", "display: none", "font-family: sans-serif", "position: absolute", "z-index: 9999", "right: 0px", "border-bottom-left-radius: 5px"]);
		n.init = function(t) {
			o = t, r = t.opts;
			var e = c;
			r.notify.styles && ( e = r.notify.styles), i = document.createElement("DIV"), i.id = "__bs_notify__", i.style.cssText = e.join(";"), document.getElementsByTagName("body")[0].appendChild(i);
			var s = n.watchEvent();
			return o.emitter.on("notify", s), o.socket.on("browser:notify", s), i
		}, n.watchEvent = function() {
			return function(t) {
				n.flash(t.message)
			}
		}, n.getElem = function() {
			...
			return o.utils.getBrowserScrollPosition().y
		}, n.flash = function(t, e) {
			var o = n.getElem();
			if (!o)
				return !1;
			var i = document.getElementsByTagName("HTML")[0];
			return i.style.position = "relative", o.innerHTML = t, o.style.top = n.getScrollTop() + "px", o.style.display = "block", window.setTimeout(function() {
